...
const BusinessSignupForm = (errors, touched, values, status) => {
    ...
    const BusinessSignupFormWithFormik = formikHOC(BusinessSignupForm);

export default BusinessSignupFormWithFormik;